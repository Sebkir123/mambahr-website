...
export const TIERS: PricingTier[] = [
  ...
  },
  {
    ...
    feats: ['Everything in Ops Manager', 'Compensation cycles, run for you', 'Compliance research with the citation', 'Layoff planning with legal checks', 'Full audit trail', 'Single sign-on, your own approval rules & security review'],
