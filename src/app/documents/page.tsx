  ...
  return (
    <div className="ack agent-edge agent-done">
      ...
      <style jsx>{`
        ...
        .a-live { display: inline-flex; align-items: center; gap: 5px; font-family: var(--font-mono); font-size: 12px; text-transform: uppercase; letter-spacing: 0.05em; color: #6A5DA6; background: rgba(106, 93, 166, 0.1); border-radius: 999px; padding: 3px 9px; }
        ...
        .bar-fill { display: block; width: 94%; height: 100%; border-radius: 999px; background: linear-gradient(90deg, #B98A4E, #7A5A2E); }
