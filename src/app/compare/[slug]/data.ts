...
export const competitors: Record<string, CompetitorData> = {
  rippling: {
    ...
    tableRows: [
      ...
      { feature: 'Payroll processing', mamba: true, them: true },
  ...
  gusto: {
    ...
    bottomLine: 'Gusto is great payroll. MambaHR is everything else — and payroll. One product. One team. One bill.',
  },
  ...
  deel: {
    ...
    tableRows: [
      ...
      { feature: 'Payroll — domestic full-time', mamba: true, them: true },
