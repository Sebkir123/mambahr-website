...
export const competitors: Record<string, CompetitorData> = {
  rippling: {
    ...
    tableRows: [
      ...
      { feature: 'Compliance engine (federal + your states, statute cited)', mamba: true, them: 'Rules-based alerts', note: 'Rippling flags issues; MambaHR resolves them' },
  ...
  gusto: {
    ...
    switchReasons: [
      {
        ...
        desc: "Gusto handles payroll. The rest, leave requests, offer letters, FMLA eligibility, onboarding tasks, terminations, still lands on someone's desk. Ask MambaHR in Slack and the work is done in seconds.",
      },
      {
        title: "Knows tax law. Doesn't know employment law.",
        desc: "Gusto nailed payroll tax compliance. It can't tell you whether Maya is eligible for FMLA, or what New York's pay transparency rule requires. MambaHR can, with the statute cited.",
      },
      {
    ...
    tableRows: [
      ...
      { feature: 'AI agent resolves HR requests end-to-end', mamba: true, them: 'Not included' },
      { feature: 'Compliance engine (federal + your states, statute cited)', mamba: true, them: 'Payroll tax compliance only' },
      { feature: 'Payroll', mamba: 'Change file, or Deel-managed', them: true, note: 'MambaHR prepares every change; a person approves every run' },
      { feature: 'Benefits administration', mamba: 'Not included (COBRA at exit only)', them: true },
    ...
    costLine: "Your Gusto history imports in a day. MambaHR feeds the change file to whichever payroll rail you keep, or runs managed payroll on Deel, and does the other twelve jobs, from $14 per employee.",
  },
  ...
  deel: {
    ...
    heroHeadline: 'Deel is global payroll and EOR.\nMambaHR is the HR department.',
    heroSub: "Deel is a global payroll and employer-of-record vendor. For the US team you employ, leave, hires, onboarding, and compliance, MambaHR is the AI HR department, in one product, and it uses Deel as its managed-payroll rail.",
    switchReasons: [
      {
      ...
      },
      {
        ...
        desc: "Even with Deel running payroll, someone still answers the policy questions, runs the offer process, files the leave. MambaHR does that work, end to end, and sends the payroll changes to Deel for you.",
      },
    ],
    tableRows: [
      { feature: 'Requests taken in Slack', mamba: true, them: 'Not included' },
      ...
      { feature: 'US compliance engine (federal + your states, statute cited)', mamba: true, them: 'Global contractor focus' },
  ...
  bamboohr: {
    ...
    switchReasons: [
      ...
      },
      {
        ...
        desc: "BambooHR holds your policies. MambaHR checks FMLA eligibility, cites the pay transparency rule for NY and CA, cites the FLSA exemption test for the role, and routes the ambiguous calls to a person.",
      },
    ],
    tableRows: [
      { feature: 'Requests taken in Slack', mamba: true, them: 'Not included' },
      { feature: 'AI resolves HR requests automatically', mamba: true, them: 'Not included' },
      { feature: 'Compliance engine (federal + your states, statute cited)', mamba: true, them: 'Not included' },
      { feature: 'Payroll', mamba: 'Change file, or Deel-managed', them: true, note: 'MambaHR prepares every change; a person approves every run' },
  ...
  namely: {
    ...
    switchReasons: [
      ...
      },
      {
        ...
        desc: "Namely tracks the data. MambaHR reasons about it, FMLA eligibility, pay transparency across states, final-pay timing, resolves the clear ones and routes the rest to a person.",
      },
    ],
    tableRows: [
      { feature: 'Requests taken in Slack', mamba: true, them: 'Not included' },
  ...
  hibob: {
    ...
    switchReasons: [
      ...
      },
      {
        ...
        desc: "HiBob is global-first, with US compliance as one of many. MambaHR is US-first, with FMLA, multi-state pay transparency, and final-pay timing baked in from day one.",
      },
    ],
    tableRows: [
      { feature: 'Requests taken in Slack', mamba: true, them: 'Limited integration' },
      { feature: 'AI resolves HR requests automatically', mamba: true, them: 'Not included' },
      { feature: 'US compliance engine (federal + your states, statute cited)', mamba: true, them: 'Not included' },
      { feature: 'Payroll', mamba: 'Change file, or Deel-managed', them: true, note: 'MambaHR prepares every change; a person approves every run' },
  ...
  adp: {
    ...
    switchReasons: [
      {
        ...
        desc: "ADP gives your HR organization a comprehensive platform to manage. MambaHR is the agent department and the record it runs on, leave, onboarding, compliance, hiring, all happening with a person on the calls that matter.",
      },
      {
    ...
    tableRows: [
      { feature: 'Requests taken in Slack', mamba: true, them: 'Not included' },
      { feature: 'AI agent resolves HR requests automatically', mamba: true, them: 'Not included' },
      { feature: 'Compliance engine (federal + your states, statute cited)', mamba: true, them: 'Payroll tax compliance' },
      { feature: 'Payroll', mamba: 'Change file, or Deel-managed', them: true, note: 'MambaHR prepares every change; a person approves every run' },
      { feature: 'Benefits administration', mamba: 'Not included (COBRA at exit only)', them: true },
  ...
  workday: {
    ...
    heroSub: "Workday is the standard enterprise HCM, vast, configurable, operated by a department of admins. MambaHR is a different shape entirely: an agent department that handles the work, with your data imported in a day and the compliance and audit depth you'd expect at scale.",
    switchReasons: [
      {
    ...
    tableRows: [
      ...
      { feature: 'Typical time to first value', mamba: '1 day to import', them: 'Months' },
      { feature: 'Designed to be self-managing', mamba: true, them: 'Requires HR & IT operators' },
      { feature: 'Compliance engine (federal + your states, statute cited)', mamba: true, them: true },
      { feature: 'Payroll', mamba: 'Change file, or Deel-managed', them: true, note: 'MambaHR prepares every change; a person approves every run' },
  ...
  justworks: {
    ...
    switchReasons: [
      ...
      },
      {
        ...
        desc: "Justworks routes the hard questions to a human support team. MambaHR answers in Slack instantly, FMLA eligibility, final-pay timing, pay transparency, with a citation, and escalates only the genuine judgment calls.",
      },
      {
    ...
    tableRows: [
      ...
      { feature: 'Compliance engine (federal + your states, statute cited)', mamba: true, them: 'Support-assisted' },
      { feature: 'Payroll', mamba: 'Change file, or Deel-managed', them: true, note: 'MambaHR prepares every change; a person approves every run' },
  ...
  trinet: {
    ...
    tableRows: [
      ...
      { feature: 'Co-employment / shared liability', mamba: 'None, you stay the employer', them: 'PEO co-employment model' },
      { feature: 'Compliance engine (federal + your states, statute cited)', mamba: true, them: 'Rep-assisted' },
      { feature: 'Payroll', mamba: 'Change file, or Deel-managed', them: true, note: 'MambaHR prepares every change; a person approves every run' },
      { feature: 'Benefits', mamba: 'Keep your own broker', them: 'PEO-bundled plans' },
      { feature: 'Hiring and recruiting automation', mamba: true, them: 'Not included' },
  ...
  paychex: {
    ...
    heroSub: "Paychex is decades-deep in payroll and add-on HR services, sold module by module with a rep on the phone. MambaHR is the AI HR department, one product that resolves the requests, runs compliance, and prepares every payroll change, with your data imported in a day.",
    switchReasons: [
      {
      ...
      },
      {
        ...
        desc: "Paychex flags payroll-tax issues. MambaHR reasons about employment law, FMLA eligibility, final-pay timing, multi-state pay transparency, cites the statute, and routes the ambiguous calls to a person.",
      },
    ],
    tableRows: [
      { feature: 'Requests taken in Slack', mamba: true, them: 'Not included' },
      { feature: 'AI agent resolves HR requests end-to-end', mamba: true, them: 'Not included' },
      { feature: 'Compliance engine (federal + your states, statute cited)', mamba: true, them: 'Payroll-tax + add-on services' },
      { feature: 'Payroll', mamba: 'Change file, or Deel-managed', them: true, note: 'MambaHR prepares every change; a person approves every run' },
      { feature: 'Benefits administration', mamba: 'Not included (COBRA at exit only)', them: true },
  ...
  zenefits: {
    ...
    switchReasons: [
      ...
      },
      {
        ...
        desc: "Zenefits stores your policies and tracks deadlines. MambaHR checks FMLA eligibility, cites the pay transparency rule for each state, and routes the ambiguous calls to a person.",
      },
    ],
    tableRows: [
      { feature: 'Requests taken in Slack', mamba: true, them: 'Not included' },
      { feature: 'AI agent resolves HR requests end-to-end', mamba: true, them: 'Not included' },
      { feature: 'Compliance engine (federal + your states, statute cited)', mamba: true, them: 'Tracking + alerts' },
  ...
  paylocity: {
    ...
    bottomLine: "Paylocity is a solid HCM suite for an HR team to run. MambaHR is the department that does the running, with your data imported in a day.",
  ...
  ukg: {
    ...
    heroSub: "UKG (Ready and Pro) is deep on workforce management and HCM for large, shift-heavy organizations, powerful, configurable, operated by a team. MambaHR is a different category: an AI HR department with your data imported in a day and the compliance and audit depth you'd expect at scale.",
    switchReasons: [
      {
  ...
  greenhouse: {
    ...
    heroSub: "Greenhouse is a strong applicant tracking system, structured interviews, pipelines, reporting. But it stops at the offer. MambaHR screens and ranks candidates, drafts the offer, and then onboards, pays, and manages the person you hired, the whole lifecycle, in one product.",
    switchReasons: [
      {
    ...
    tableRows: [
      ...
      { feature: 'Compliance engine (federal + your states, statute cited)', mamba: true, them: 'EEOC reporting only' },
      { feature: 'Leave, compensation & the HR long tail', mamba: true, them: 'Not included' },
      { feature: 'Human approval on key decisions', mamba: true, them: 'Manual workflows' },
      { feature: 'Typical setup time', mamba: '1 day to import', them: '2–4 weeks' },
    ],
  ...
  lever: {
    ...
    heroSub: "Lever pairs an ATS with candidate-relationship tools to help your recruiters source and nurture. It ends at the offer. MambaHR screens and ranks candidates, drafts the offer, and then onboards, pays, and manages them, the full lifecycle, in one product.",
    switchReasons: [
      {
      ...
      },
      {
        ...
        desc: "Lever organizes your funnel and reminds your team. MambaHR screens and ranks candidates, advisory only, drafts the offer in band, and after the hire, resolves HR requests end-to-end. Interview scheduling is coming.",
      },
      {
  ...
  remote: {
    ...
    heroSub: "Remote is built for global employer-of-record and contractor payments, paying anyone, anywhere. For the US team you actually employ, leave, hiring, onboarding, and compliance, MambaHR is the AI HR department, in one product.",
    switchReasons: [
      {
        title: "EOR payments aren't an HR department.",
        desc: "Remote optimized for paying people across countries. Your US team still needs FMLA and state leave management, multi-state compliance, and onboarding that runs without chasing. That's MambaHR.",
      },
      {
      ...
      },
      {
        ...
        desc: "Even with Remote running payments, someone answers the policy questions, runs the offer process, and files leave. MambaHR handles that work, end to end.",
      },
    ],
    tableRows: [
      { feature: 'Requests taken in Slack', mamba: true, them: 'Not included' },
      { feature: 'AI agent resolves HR requests end-to-end', mamba: true, them: 'Not included' },
      { feature: 'US leave management (FMLA, state laws)', mamba: true, them: 'Basic only' },
      { feature: 'US compliance engine (federal + your states, statute cited)', mamba: true, them: 'Global EOR focus' },
  ...
  oyster: {
    ...
    heroSub: "Oyster is a global employment platform for hiring and paying people in other countries through EOR. For the US team you actually employ, leave, hiring, onboarding, and compliance, MambaHR is the AI HR department, in one product.",
    switchReasons: [
      {
        title: 'Global EOR is a different job than US HR.',
        desc: "Oyster optimized for compliant hiring across borders. Your US team needs FMLA and state leave reasoning, multi-state compliance, and onboarding that runs without chasing. MambaHR is built for exactly that.",
      },
      {
