      ...
      <main>
        ...
        <section className="guar">
          ...
          <style jsx>{`
            ...
            .g-mark { flex: none; width: 52px; height: 52px; border-radius: 999px; background: linear-gradient(135deg, var(--gold-mid), var(--violet)); color: #fff; display: flex; align-items: center; justify-content: center; box-shadow: 0 10px 22px rgba(106, 93, 166, 0.25); }
