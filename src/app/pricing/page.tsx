...
const tiers = [
  ...
  },
  {
    ...
    desc: 'Multiple legal entities, international headcount, advanced security. Custom sign-off policy, dedicated infra, SLA.',
    features: [
      ...
      'Custom sign-off policy configuration',
    ],
    cta: 'Talk to sales',
    highlight: false,
  },
...
const faqs = [
  ...
  { q: 'What does the pilot look like?', a: 'Day 1: connect your HRIS and run a data audit. Day 2: agent goes live with everything routed for your sign-off. Day 3+: as you build trust, lower-risk actions move to automatic. Most teams hit steady state inside a week.' },
  ...
  { q: 'What does migration look like?', a: "MambaHR is the HRIS — we replace whatever you have today. Day 1 we map your data model from Gusto/Workday/Rippling/BambooHR/Namely/Personio/HiBob. Day 2 we run a dry-import and you verify. Day 3 we switch over. Most teams are fully migrated in a week." },
