  ...
  return (
    <div className="qw agent-edge agent-working agent-lg">
      ...
      <style jsx>{`
        ...
        .p-count { font-family: var(--font-mono); font-size: 12px; color: var(--gold); background: var(--gold-tint); border-radius: 999px; padding: 2px 8px; }
        ...
        .ap-ok { font-size: 13px; font-weight: 600; color: #fff; background: var(--text); border-radius: 999px; padding: 7px 15px; }
