...
const STAGES: Stage[] = [
  ...
  },
  {
    ...
    log: [
      { t: '9:02', text: 'Form I-9 started, paperwork filed' },
      { t: '9:05', text: 'Email, Slack, and SSO logins requested' },
      { t: '9:07', text: 'First-week plan set with the team' },
    ],
    chips: ['Form I-9 started', 'Accounts requested'],
    state: 'done',
    stateText: 'MambaHR · requests out in minutes',
  },
  {
    label: 'Payroll changes',
    headline: 'Payday, prepped and checked twice.',
    sub: 'Every raise, new hire, and change is in the pay file before payday, reconciled twice. A person approves every run.',
    person: { img: '/avatars/priya.jpg', name: 'Jordan Lee', role: 'address change' },
    log: [
      { t: 'Mon', text: 'Every change ready for payday' },
      { t: 'Tue', text: 'Change file built, or sent to Deel' },
      { t: 'Wed', text: 'Double-checked, nothing missed' },
    ],
    chips: ['Payroll-ready', 'You approve'],
    state: 'working',
  ...
  },
  {
    ...
    sub: 'Normal time off approves itself in seconds. Family and medical leave gets the FMLA check and the statute attached; a person confirms the state overlay.',
    person: { img: '/avatars/violet.jpg', name: 'Violet Hayes', role: 'parental leave' },
    log: [
      { t: '9:14', text: 'Request read, answered in the same minute' },
      { t: '9:14', text: 'FMLA checked, statute attached' },
      { t: '9:14', text: 'Record and payday already updated' },
    ],
    chips: ['FMLA', 'Statute cited'],
    state: 'done',
