  ...
  return (
    <div className="sf agent-edge agent-done">
      ...
      <style jsx>{`
        ...
        .sf-chip { margin-left: auto; font-family: var(--font-mono); font-size: 12px; color: #fff; background: linear-gradient(120deg, #B98A4E, #6A5DA6); border-radius: 999px; padding: 4px 11px; }
        ...
        .sf-av-h { background: linear-gradient(135deg, #C99655, #7A5A2E); }
        ...
        .sf-bot { font-family: var(--font-mono); font-size: 12px !important; text-transform: uppercase; letter-spacing: 0.05em; color: #6A5DA6 !important; background: rgba(106, 93, 166, 0.12); border-radius: 4px; padding: 1px 5px; }
